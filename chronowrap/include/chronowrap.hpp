...
//
////NOTE: This function only works if the string is null terminated.  Running on non-null terminated strings is undefined
//inline bool timestamp::fromstring(const char* tstamp, const char* format, size_t tlen = 0, size_t flen = 0)
//{
//	if (!tstamp || !format)
//		return false;
//
...
//		if (*format == '%')
//		{
//			++format; //should still be safe to dereference since we can count on null terminator
//			switch (*format)
//			{
//			case 'Y':
//				if (!assigntmparam(&tstamp, tend, 4, 4, t.tm_year, 1900, 9999))
//					return false;
//				t.tm_year -= 1900;
//				break;
//			case 'M': //month 1-12
//				if (!assigntmparam(&tstamp, tend, 2, 2, t.tm_mon, 0, 11))
//					return false;
//				--t.tm_mon;
//				break;
//			case 'd': //day 1-31
//				if (!assigntmparam(&tstamp, tend, 2, 2, t.tm_mday, 1, 31))
//					return false;
//				break;
//			case 'H': //24 hour representation
//				if (!assigntmparam(&tstamp, tend, 2, 2, t.tm_hour, 0, 23))
//					return false;
//				break;
//			case 'm': //minute 0-59
//				if (!assigntmparam(&tstamp, tend, 2, 2, t.tm_min, 0, 59))
//					return false;
//				break;
//			case 's': //seconds 0-59
//				if (!assigntmparam(&tstamp, tend, 2, 2, t.tm_sec, 0, 59))
//					return false;
//				break;
//			case 'x': //left padded milliseconds 0-1000
//				if (!assigntmparam(&tstamp, tend, 1, 3, ns, 0, 999))
//					return false;
//				ns *= 1000000;
//				break;
//			case 'f': //left padded nanoseconds 0-999999999
//				if (!assigntmparam(&tstamp, tend, 1, 9, ns, 0, 999999999))
//					return false;
//				break;
//			case '%':
//				++tstamp;
...
//
//	auto tt = mktime(&t);
//	time = std::chrono::system_clock::from_time_t(tt) + durcast<std::chrono::system_clock::duration>(t_nsec(ns));
//	return true;
//}
